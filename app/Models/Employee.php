...
class Employee extends Model
{
    ...
    public static function deductions($id)
    {
        ...
        $deductions = $total_loan + $total_saturation_deduction;
    ...
    public static function get_gross_salary($id)
    {
        ...
        $gross_salary = $total_allowance + $total_commission + $total_other_payment + $total_over_time;

        //$employee       = Employee::where('id', '=', $id)->first();

        //$gross_salary     = (!empty($employee->salary) ? $employee->salary : 0) + $adv_gross_salary;
