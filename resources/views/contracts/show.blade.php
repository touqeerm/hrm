                                                                ...
                                                                <div class="row align-items-center">
                                                                    <div class="col-auto">
                                                                        ...
                                                                        <a href="{{ !empty($user->avatar) ? asset(Storage::url('uploads/avatar/')) . '/' . $user->avatar : asset(Storage::url('uploads/avatar/')) . '/avatar.png' }}" target="_blank">
                                                                            <img class="rounded-circle"  width="25" height="25" src="{{ !empty($user->avatar) ? asset(Storage::url('uploads/avatar/')) . '/' . $user->avatar : asset(Storage::url('uploads/avatar/')) . '/avatar.png' }}">
                                                                        </a>
                                                                    </div>
                                                                    <div class="col ml-n2">
