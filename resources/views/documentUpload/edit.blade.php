            ...
            <div class="form-group">
                ...
                <div class="choose-files ">
                    <label for="document">
                        ...
                        <img id="blah" class="mt-3" alt="your image" width="100" src="@if($ducumentUpload->document){{asset(Storage::url('uploads/documentUpload/'.$ducumentUpload->document))}} @else {{asset('/storage/uploads/uploadDocument/document.png')}} @endif"/>
                    </label>
                </div>
            </div>
        </div>
