                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-end">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12 col-12 mx-2 ">
                            <div class="btn-box">
                                ...
                                <select class="form-control select" id="type" name="type" tabindex="-1" aria-hidden="true">
                                    <option value="income" <?php echo e(isset($_GET['account']) && $_GET['type'] == 'income' ? 'selected' : ''); ?>>
                                        <?php echo e(__('Income')); ?></option>
                                    <option value="expense" <?php echo e(isset($_GET['account']) && $_GET['type'] == 'expense' ? 'selected' : ''); ?>>
                        ...
                        <div class="col-auto float-end ms-2 mt-4">
                            ...
                            <a href="<?php echo e(route('report.account.statement')); ?>" class="btn btn-sm btn-danger " data-bs-toggle="tooltip"
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        ...
                                        <?php endif; ?> <?php echo e(\Auth::user()->priceFormat($account->total)); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\hrm\resources\views/report/account_statement.blade.php ENDPATH**/ ?>