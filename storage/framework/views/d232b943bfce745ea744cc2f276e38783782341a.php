                                ...
                                <div class="card-header card-body">
                                    <div class="row text-xs">
                                        ...
                                        <?php if($emailTemplate->slug=='create_user'): ?>
                                            ...
                                            <?php elseif($emailTemplate->slug=='employee_create'): ?>
                                            <div class="row">
                                        ...
                                        <?php elseif($emailTemplate->slug=='payroll_create'): ?>
                                            <div class="row">
                                        ...
                                        <?php elseif($emailTemplate->slug=='ticket_create'): ?>
                                            <div class="row">
                                        ...
                                        <?php elseif($emailTemplate->slug=='award_create'): ?>
                                            <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\hrm\resources\views/email_templates/show.blade.php ENDPATH**/ ?>